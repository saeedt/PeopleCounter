// ---------------------------------------------------------------------------
// NewPing Library - v1.9 - 05/16/2017
//
// AUTHOR/LICENSE:
...
//   sonar.ping_in_tc(temp,[max_cm_distance]) - Send a ping and get the temperature corrected distance in whole inches. [max_cm_distance] allows you to optionally set a new max distance.
//   sonar.ping_cm_tc(temp,[max_cm_distance]) - Send a ping and get the temperature corrected distance in whole centimeters. [max_cm_distance] allows you to optionally set a new max distance.
...
class NewPing {
	public:
		...
		unsigned long ping_cm_tc(float temp = 21, unsigned int max_cm_distance = 0);
		unsigned long ping_in_tc(float temp = 21, unsigned int max_cm_distance = 0);
